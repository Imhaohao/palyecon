  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center mb-6">
        <Instagram className="h-8 w-8 text-paly-blue mr-3" />
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div className="flex justify-center">
          <blockquote 
            ...
            data-instgrm-permalink="https://www.instagram.com/palyecon/?utm_source=ig_embed&amp;utm_campaign=loading" 
          ...
          >
            <div style={{ padding: '16px' }}>
              <a 
                href="https://www.instagram.com/palyecon/?utm_source=ig_embed&amp;utm_campaign=loading" 
                style={{ 
                  background: '#FFFFFF', 
                  lineHeight: '0', 
                  padding: '0 0', 
              ...
              <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: '0', marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                <a href="https://www.instagram.com/palyecon/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px' }} target="_blank">
                  Paly Economics Club
                </a> (@<a href="https://www.instagram.com/palyecon/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px' }} target="_blank">
                  palyecon
      ...
      {/* Call to Action */}
      <div className="bg-gradient-to-r from-paly-blue to-paly-green rounded-lg p-6 text-white text-center">
        <h3 className="text-xl font-semibold mb-2">Stay Connected!</h3>
        <p className="mb-4 opacity-90">
          Follow us on Instagram for the latest updates, competition results, and behind-the-scenes content.
        </p>
        <a
          href="https://www.instagram.com/palyecon/"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-white hover:bg-gray-100 text-paly-navy px-6 py-3 rounded-lg font-semibold transition-colors inline-flex items-center"
        >
